...
## Algorithm
1.Start.
2.Define Node structure with float data and next pointer.
3.Initialize top = NULL.
4.Call push() to insert elements at top.
5.If top == NULL, print underflow in pop and exit.
6.Remove top node using pop(), free memory, update top.
7.Return top value using peek() without removing node.
8. peek before and after pop to verify LIFO.
9.Stop. 
## Program:
```
/*
